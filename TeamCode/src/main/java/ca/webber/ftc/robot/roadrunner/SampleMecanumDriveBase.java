...
import ca.webber.ftc.robot.roadrunner.util.DashboardUtil;

import static ca.webber.ftc.robot.roadrunner.DriveConstants.BASE_CONSTRAINTS;
import static ca.webber.ftc.robot.roadrunner.DriveConstants.TRACK_WIDTH;
import static ca.webber.ftc.robot.roadrunner.DriveConstants.kA;
import static ca.webber.ftc.robot.roadrunner.DriveConstants.kStatic;
import static ca.webber.ftc.robot.roadrunner.DriveConstants.kV;
...
public abstract class SampleMecanumDriveBase extends MecanumDrive {
    ...
    public TrajectoryBuilder trajectoryBuilder(double heading) {
        return new TrajectoryBuilder(getPoseEstimate(), heading, constraints);
    }

    public TrajectoryBuilder trajectoryBuilder(Pose2d pose, double heading) {
        return new TrajectoryBuilder(pose, heading, constraints);
    }
